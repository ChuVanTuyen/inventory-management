...
// @ts-nocheck 
/*
 * This file exports the `SalesSummary` model and its related types.
 *
...
export type GetSalesSummaryAggregateType<T extends SalesSummaryAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSalesSummary[P]>
    : Prisma.GetScalarType<T[P], AggregateSalesSummary[P]>
}
...
type GetSalesSummaryGroupByPayload<T extends SalesSummaryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SalesSummaryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SalesSummaryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SalesSummaryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SalesSummaryGroupByOutputType[P]>
      }
    >
  >
...
export type SalesSummaryOrderByWithRelationInput = {
  ...
  _relevance?: Prisma.SalesSummaryOrderByRelevanceInput
}
...
export type SalesSummaryOrderByRelevanceInput = {
  fields: Prisma.SalesSummaryOrderByRelevanceFieldEnum | Prisma.SalesSummaryOrderByRelevanceFieldEnum[]
...
export type SalesSummaryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface SalesSummaryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends SalesSummaryCountArgs>(
    args?: Prisma.Subset<T, SalesSummaryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SalesSummaryCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, SalesSummaryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSalesSummaryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
