...
// @ts-nocheck 
/*
 * This file exports the `PurchaseSummary` model and its related types.
 *
...
export type GetPurchaseSummaryAggregateType<T extends PurchaseSummaryAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePurchaseSummary[P]>
    : Prisma.GetScalarType<T[P], AggregatePurchaseSummary[P]>
}
...
type GetPurchaseSummaryGroupByPayload<T extends PurchaseSummaryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PurchaseSummaryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PurchaseSummaryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PurchaseSummaryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PurchaseSummaryGroupByOutputType[P]>
      }
    >
  >
...
export type PurchaseSummaryOrderByWithRelationInput = {
  ...
  _relevance?: Prisma.PurchaseSummaryOrderByRelevanceInput
}
...
export type PurchaseSummaryOrderByRelevanceInput = {
  fields: Prisma.PurchaseSummaryOrderByRelevanceFieldEnum | Prisma.PurchaseSummaryOrderByRelevanceFieldEnum[]
...
export type PurchaseSummaryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface PurchaseSummaryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends PurchaseSummaryCountArgs>(
    args?: Prisma.Subset<T, PurchaseSummaryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PurchaseSummaryCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, PurchaseSummaryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPurchaseSummaryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
